...
Sont demandés: <br>- user et mot de passe pour l'accès au serveur de base de 
    données MySql<br>- identifiant de modification d'enrgistrement: cet identifiant 
...
Cet écran liste les enregistrements répondant aux critères optionnels donnés 
    ...
    valeur stockée, ce qui peut peut donc donner des résultats assez bizarres.<br><br><img src="telecharger.gif" width="70" height="11" border="0"> 
...
Cet écran permet l'édition ou copie d'un enregistrement.<br>Le bouton <img src="valider.gif" width="70" height="13" border="0"> 
...
Ceci permet de spécifier des MAJ automatiques sur les champs pendant leur affichage pour édition <br>
...
<p><a href="#" onclick="self.close();"><img src="retour.gif" width="70" height="11" border="0" alt="fermer cette fenêtre"></a>
</p>
</body>
</html>
